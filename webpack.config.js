        ...
        rules: [
...

            {
                ...
                use: [{
                    ...
                    options: {
                        name: '[name].[ext]',
                        outputPath: 'fonts/',    // where the fonts will go in build/
                        publicPath: '../fonts/'  // path relative to build/css used in url
                    }
                }]
            },

            // Support for *.json files.
            {test: /\.json$/, loader: 'json-loader', exclude: [root('src', 'language'), root('src', 'legacy'), root('src', 'config')]},
